/**
 * @file lichuang_dev_board.cc
 * @brief 立创开发板硬件抽象层实现
 * @details 该文件实现了基于ESP32-S3的立创开发板的硬件抽象层，包括I2C、SPI、显示屏、触摸屏、摄像头等外设的初始化和控制
 */
 ...
 * @brief 立创开发板主类
 * @details 继承自WifiBoard，实现立创开发板的所有硬件功能
 */
...
// 条件编译：如果启用了设备端AEC功能
    ...
    void InitializeSt7789Display()
    {
        ...
        io_config.pclk_hz = 20 * 1000 * 1000; // 像素时钟20MHz
    ...
    /**
     * @brief 初始化触摸屏功能
     * @details 配置FT5x06触摸屏驱动和LVGL触摸接口
     */
